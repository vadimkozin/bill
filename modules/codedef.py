...
class Codedef(object):
    ...
    def _update_code(self, info='-'):
        ...
        # 2024-04-01 добавили поле "Територия" (area), почти всегда совпадаетс с "Регион"(region)
        # 901;0135500;0135599;100;ООО "Т2 Мобайл";Красноярский край;Красноярский край;7743895280
        # 901;0135600;0135699;100;ООО "Т2 Мобайл";Забайкальский край;Забайкальский край;7743895280
        # 901;0135700;0135799;100;ООО "Т2 Мобайл";Корякский округ|Камчатский край;м.р-н Муниципальные районы Камчатского края, входящие в состав Корякского округа|Камчатский край;7743895280
        # 997;6133327;6133327;1;ООО "БИТ-ЦЕНТР";Московская область * Москва|Московская область * Москва;Московская область, Город Москва;7725759983
        # 939;9755000;9755999;1000;ПАО "МЕГАФОН";-;Республика Адыгея;7812014560
        # 978;4445000;4445999;1000;ООО "МИРАНДА-МЕДИА";-;Краснодарский край;7702527584
        ...
        for line in f:
            ...
            abc, fm, to, capacity, oper, region, area, inn = line.strip().split(';')
            ...
            # 2024-04-01 в данных добавили поле "Территория", а в коде это area
            regs = region.split('|')
            if len(regs) > 1:
                region = regs[0].strip()

            if (region == "null" or region == '-') and len(area) > 0:
                region = area
